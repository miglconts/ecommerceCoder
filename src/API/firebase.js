...
export async function addItemsToFB() {
  const products = [
    ...
    },
    {
      ...
      stock: 123,
      category: "smartphones",
      img: "https://dummyjson.com/image/i/products/4/thumbnail.jpg",
    },
    {
      id: 5,
      title: "Huawei P30",
    ...
    },
    {
      ...
      stock: 89,
      category: "laptops",
      img: "https://dummyjson.com/image/i/products/10/thumbnail.jpeg",
    },
    {
      id: 11,
      title: "perfume Oil",
    ...
    },
    {
      ...
      stock: 52,
      category: "fragrances",
      img: "https://dummyjson.com/image/i/products/12/thumbnail.jpg",
    },
    {
      id: 13,
    ...
    },
    {
      ...
      stock: 114,
      category: "fragrances",
      img: "https://dummyjson.com/image/i/products/14/thumbnail.jpg",
    },
    {
      id: 15,
      ...
      stock: 105,
      category: "fragrances",
      img: "https://dummyjson.com/image/i/products/15/thumbnail.jpg",
    },
    {
      id: 16,
    ...
    },
    {
      ...
      stock: 78,
      category: "skincare",
      img: "https://dummyjson.com/image/i/products/17/thumbnail.jpg",
    },
    {
      id: 18,
      ...
      stock: 88,
      category: "skincare",
      img: "https://dummyjson.com/image/i/products/18/thumbnail.jpg",
    },
    {
      id: 19,
      ...
      stock: 54,
      category: "skincare",
      img: "https://dummyjson.com/image/i/products/19/thumbnail.jpg",
    },
    {
      id: 20,
      ...
      stock: 140,
      category: "skincare",
      img: "https://dummyjson.com/image/i/products/20/thumbnail.jpg",
    },
    {
      id: 21,
    ...
    },
    {
      ...
      stock: 146,
      category: "groceries",
      img: "https://dummyjson.com/image/i/products/22/thumbnail.jpg",
    },
    {
      id: 23,
      ...
      stock: 26,
      category: "groceries",
      img: "https://dummyjson.com/image/i/products/23/thumbnail.jpg",
    },
    {
      id: 24,
      ...
      stock: 113,
      category: "groceries",
      img: "https://dummyjson.com/image/i/products/24/thumbnail.jpg",
    },
    {
      id: 25,
      ...
      stock: 47,
      category: "groceries",
      img: "https://dummyjson.com/image/i/products/25/thumbnail.jpg",
    },
    {
      id: 26,
    ...
    },
    {
      ...
      stock: 17,
      category: "home-decoration",
      img: "https://dummyjson.com/image/i/products/27/thumbnail.webp",
    },
    {
      id: 28,
...
export async function createOrder(order) {
  ...
  console.log(`Nueva compra creada con id => ${newOrder.id}`);
  return newOrder.id;
}

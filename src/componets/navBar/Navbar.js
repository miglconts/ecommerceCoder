      ...
      <div className="container flex  w-6/12 items-start flex-wrap mx-auto cursor-pointer">
        ...
        <div className="w-full block flex-grow text-left lg:flex lg:items-center lg:w-auto">
          <div className="text-xl lg:flex-grow">
            <a
              href="/"
              className="block px-5 mx-1 border-b-4 border-blue-300 hover:border-blue-600   mt-4 lg:inline-block lg:mt-0 text-blue-900 hover:text-blue-600 mr-4"
            >
              Blog
            </a>
            <a
            ...
            <a
              href="/"
              className="block px-5 mx-1 border-b-4 border-blue-300 hover:border-blue-600   mt-4 lg:inline-block lg:mt-0 text-blue-900 hover:text-blue-600"
            >
              About
            </a>
          </div>
